  ...
  return (
    <div className="bg-[url('/images/b1.png')] bg-no-repeat bg-center bg-cover">
      <div className=" bg-[rgba(0,0,0,0.5)]">
        <nav
          className={`bg-transparent border-gray-200 dark:bg-transparent flex justify-between`}
        >
          <div
            className={`${
              isVisible ? 'bg-white border-b' : 'bg-transparent '
            } fixed top-0 h-16 w-full md:h-20 flex flex-wrap items-center justify-between mx-auto p-4 px-[5%] lg:px-[10%]`}
          >
            <a
              href=""
            ...
            >
              <span
                className={`self-center text-2xl ${
                  isVisible ? 'text-black dark:text-black' : 'text-white'
            ...
            <button
              ...
              type="button"
              className={`inline-flex items-center p-2 w-10 h-10 justify-center text-sm rounded-lg md:hidden hover:bg-white hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-white dark:hover:bg-white dark:focus:ring-white"
            ...
            <div
              ...
              id="navbar-solid-bg"
            >
              <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-transparent md:dark:bg-transparent dark:border-gray-700 shadow md:shadow-none">
                {navlinks.map((link) => (
                  <li key={link.url}>
                    <a
                      href="#"
                      className={`py-2 md:py-3 mb-2 md:mb-0 px-1 md:p-0 ${
                        isVisible ? 'text-black ' : 'text-black md:text-white'
                      }  rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#009379] md:dark:hover:text-[#009379] dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 ${
                        link.className
                      }`}
                    >
                      {link.name}
          ...
          <div className="p-10 md:p-20 pt-[200px] text-center bg-transparent rounded-lg shadow sm:pt-[400px] md:pt-[400px] dark:bg-transparent mx-auto">
            ...
            <div className="items-center justify-center space-y-4 sm:flex sm:space-y-0  rtl:space-x-reverse">
              <form className="flex max-w-lg w-[95%] md:w-[80%] mx-auto">
                <input
                  type="search"
                  id="search"
                ...
                <button
                  type="submit"
                  className="text-white bg-[#009379] hover:bg-[#009379] rounded-r-lg focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm px-5 py-2.5 text-center dark:bg-[#009379] dark:hover:bg-[#009379] dark:focus:ring-[#009379]"
                >
